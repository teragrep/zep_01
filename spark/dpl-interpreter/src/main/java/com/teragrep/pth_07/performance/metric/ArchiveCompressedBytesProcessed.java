...
public final class ArchiveCompressedBytesProcessed implements PerformanceMetric {
    ...
    public ArchiveCompressedBytesProcessed(final long value){
        this(new MetricValueImpl<>(value));
    }
    private ArchiveCompressedBytesProcessed(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public ArchiveCompressedBytesProcessed withValue(java.lang.Object value) throws IncompatibleValueException {
        final ArchiveCompressedBytesProcessed modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new ArchiveCompressedBytesProcessed(newValue);
            }
                ...
                modifiedMetric = new ArchiveCompressedBytesProcessed((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final ArchiveCompressedBytesProcessed that = (ArchiveCompressedBytesProcessed) o;
