...
public final class BytesPerSecond implements PerformanceMetric<Long> {
    ...
    public BytesPerSecond(final long value){
        this(new MetricValueImpl<>(value));
    }
    private BytesPerSecond(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public BytesPerSecond withValue(java.lang.Object value) throws IncompatibleValueException {
        final BytesPerSecond modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new BytesPerSecond(newValue);
            }
            ...
            modifiedMetric = new BytesPerSecond((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public String description() {
        return "processed bytes per second";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final BytesPerSecond that = (BytesPerSecond) o;
