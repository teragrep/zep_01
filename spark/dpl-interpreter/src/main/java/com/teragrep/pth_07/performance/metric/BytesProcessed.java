...
public final class BytesProcessed implements PerformanceMetric<Long> {
    private final MetricValue<Long> value;
    public BytesProcessed(){
        this(new StubMetricValue<>());
    }
    public BytesProcessed(final long value){
        this(new MetricValueImpl<>(value));
    }
    private BytesProcessed(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public BytesProcessed withValue(java.lang.Object value) throws IncompatibleValueException {
        final BytesProcessed modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new BytesProcessed(newValue);
            }
            ...
            modifiedMetric = new BytesProcessed((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final BytesProcessed that = (BytesProcessed) o;
