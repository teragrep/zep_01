...
public final class LatestKafkaTimestamp implements PerformanceMetric {
    ...
    public LatestKafkaTimestamp(final long value){
        this(new MetricValueImpl<Long>(value));
    }
    private LatestKafkaTimestamp(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public LatestKafkaTimestamp withValue(java.lang.Object value) throws IncompatibleValueException {
        final LatestKafkaTimestamp modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new LatestKafkaTimestamp(newValue);
            }
            ...
            modifiedMetric = new LatestKafkaTimestamp((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public String description() {
        return "latest processed kafka records' timestamp";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final LatestKafkaTimestamp that = (LatestKafkaTimestamp) o;
