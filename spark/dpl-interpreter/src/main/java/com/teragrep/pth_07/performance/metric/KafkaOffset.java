...
public final class KafkaOffset implements PerformanceMetric {
    ...
    public KafkaOffset(final long value){
        this(new MetricValueImpl<>(value));
    }
    private KafkaOffset(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public KafkaOffset withValue(java.lang.Object value) throws IncompatibleValueException {
        final KafkaOffset modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new KafkaOffset(newValue);
            }
            ...
            modifiedMetric = new KafkaOffset((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final KafkaOffset that = (KafkaOffset) o;
