...
public final class ArchiveDatabaseRowMinLatency implements PerformanceMetric<Long> {
    ...
    public ArchiveDatabaseRowMinLatency(final long value){
        this(new MetricValueImpl<>(value));
    }
    private ArchiveDatabaseRowMinLatency(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public ArchiveDatabaseRowMinLatency withValue(java.lang.Object value) throws IncompatibleValueException {
        final ArchiveDatabaseRowMinLatency modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new ArchiveDatabaseRowMinLatency(newValue);
            }
            ...
            modifiedMetric = new ArchiveDatabaseRowMinLatency((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public String description() {
        return "minimum time per row in nanoseconds";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final ArchiveDatabaseRowMinLatency that = (ArchiveDatabaseRowMinLatency) o;
