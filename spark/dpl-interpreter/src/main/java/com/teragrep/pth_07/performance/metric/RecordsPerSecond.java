...
public final class RecordsPerSecond implements PerformanceMetric<Long> {
    private final MetricValue<Long> value;
    public RecordsPerSecond(){
        this(new StubMetricValue<>());
    }
    public RecordsPerSecond(final long value){
        this(new MetricValueImpl<>(value));
    }
    private RecordsPerSecond(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public RecordsPerSecond withValue(java.lang.Object value) throws IncompatibleValueException {
        final RecordsPerSecond modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new RecordsPerSecond(newValue);
            }
            ...
            modifiedMetric = new RecordsPerSecond((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public String description() {
        return "processed records per second";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final RecordsPerSecond that = (RecordsPerSecond) o;
