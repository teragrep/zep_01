...
public final class BatchId implements PerformanceMetric {
    ...
    public BatchId(final long value){
        this(new MetricValueImpl<>(value));
    }
    private BatchId(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public BatchId withValue(java.lang.Object value) throws IncompatibleValueException {
        final BatchId modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new BatchId(newValue);
            }
            ...
            modifiedMetric = new BatchId((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public String description() {
        return "sequence number of the batch";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final BatchId batchId = (BatchId) o;
