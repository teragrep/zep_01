...
public final class BytesProcessedImpl implements BytesProcessed {
    private final long value;
    public BytesProcessedImpl(final long value){
        this.value = value;
    }
    @Override
    ...
    public boolean equals(final Object o) {
        ...
        final BytesProcessedImpl that = (BytesProcessedImpl) o;
