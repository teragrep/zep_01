...
public final class ArchiveDatabaseRowCount implements PerformanceMetric<Long> {
    ...
    public ArchiveDatabaseRowCount(final long value){
        this(new MetricValueImpl<Long>(value));
    }
    private ArchiveDatabaseRowCount(final MetricValue<Long> value){
        this.value = value;
    }
    ...
    @Override
    public ArchiveDatabaseRowCount withValue(java.lang.Object value) throws IncompatibleValueException {
        final ArchiveDatabaseRowCount modifiedMetric;
        if(value instanceof String){
            try{
                long newValue = Long.parseLong((String)value);
                modifiedMetric = new ArchiveDatabaseRowCount(newValue);
            }
            ...
            modifiedMetric = new ArchiveDatabaseRowCount((Long)value);
        }
        else {
            throw new IncompatibleValueException("Value "+value+" is not a compatible value for metric "+name());
        }
    ...
    public String description() {
        return "number of processed archive database rows";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final ArchiveDatabaseRowCount that = (ArchiveDatabaseRowCount) o;
