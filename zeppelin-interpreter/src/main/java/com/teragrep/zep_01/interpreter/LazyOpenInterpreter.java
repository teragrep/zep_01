...
public class LazyOpenInterpreter
  ...
  @Override
  public void formatDataset(String noteId, String paragraphId, Options options) throws InterpreterException{
    this.intp.formatDataset(noteId, paragraphId, options);
  }
}
