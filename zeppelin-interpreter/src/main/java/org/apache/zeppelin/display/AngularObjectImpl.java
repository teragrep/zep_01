 ...
 * @param <T>
 */
public class AngularObjectImpl<T> implements AngularObject<T> {
  private static final Logger LOGGER = LoggerFactory.getLogger(AngularObjectImpl.class);
   ...
   */
  public AngularObjectImpl(String name, T o, String noteId, String paragraphId,
  ...
  public boolean equals(Object o) {
    ...
    AngularObjectImpl<?> that = (AngularObjectImpl<?>) o;
  ...
  public void set(T o, boolean emit) {
    ...
    final Logger logger = LoggerFactory.getLogger(AngularObjectImpl.class);
  ...
  public static AngularObject<?> fromJson(String json) {
    return GSON.fromJson(json, AngularObjectImpl.class);
  }
}
