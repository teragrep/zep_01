...
public class AuthenticationInfoImpl implements AuthenticationInfo {
  private static final Logger LOG = LoggerFactory.getLogger(AuthenticationInfoImpl.class);
  ...
  public static final AuthenticationInfo ANONYMOUS = new AuthenticationInfoImpl("anonymous", new HashSet<>(),
      "anonymous");

  public AuthenticationInfoImpl() {}

  public AuthenticationInfoImpl(String user) {
    this.user = user;
  }
   ...
   * @param ticket
   */
  public AuthenticationInfoImpl(String user, Set<String> roles, String ticket) {
    this.user = user;
    this.ticket = ticket;
    this.roles = roles;
  }

  public AuthenticationInfoImpl(String user, String roles, String ticket) {
    this.user = user;
    this.ticket = ticket;
  ...
  public static AuthenticationInfo fromJson(String json) {
    return GSON.fromJson(json, AuthenticationInfoImpl.class);
  }
}
