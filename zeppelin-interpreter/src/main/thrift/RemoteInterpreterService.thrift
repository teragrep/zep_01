...
service RemoteInterpreterService {
  ...
  void formatDataset(1: string sessionId, 2: string className, 3: string noteId, 4: string paragraphId 5: string visualizationLibraryName, 6: Options options) throws (1: InterpreterRPCException ex);
  void shutdown();
