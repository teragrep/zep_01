 ...
 *    mvn -Dtest=com.teragrep.zep_01.integration.ZeppelinIT -Denforcer.skip=true \
...
public class ZeppelinIT extends AbstractZeppelinIT {
  ...
  public void testAngularDisplay() throws Exception {
    try {
      ...
      /*
       * Register watcher
       * z.angularWatch("myVar", (before:Object, after:Object, context:com.teragrep.zep_01.interpreter.InterpreterContext) => {
       *   z.run(2, context)
       * }
       */
      setTextOfParagraph(4, "z.angularWatch(\"myVar\", (before:Object, after:Object, context:com.teragrep.zep_01.interpreter.InterpreterContext)=>{ z.run(2, false)})");
      runParagraph(4);
