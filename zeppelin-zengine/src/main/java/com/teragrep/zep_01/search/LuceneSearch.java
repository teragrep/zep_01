...
public class LuceneSearch extends SearchService {
  ...
  /* (non-Javadoc)
   * @see com.teragrep.zep_01.search.Search#query(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.teragrep.zep_01.search.Search#updateIndexDoc(com.teragrep.zep_01.notebook.Note)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.teragrep.zep_01.search.Search#addIndexDoc(com.teragrep.zep_01.notebook.Note)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.teragrep.zep_01.search.Search#deleteIndexDocs(com.teragrep.zep_01.notebook.Note)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.teragrep.zep_01.search.Search
  ...
  /* (non-Javadoc)
   * @see com.teragrep.zep_01.search.Search#close()
   */
  @Override
  @PreDestroy
  public void close() {
