...
RUN echo "unsafe-perm=true" > ~/.npmrc && \
    ...
    # mvn -B package -DskipTests -Pbuild-distr -Pspark-3.0 -Pinclude-hadoop -Phadoop3 -Pspark-scala-2.12 -Pweb-angular -pl '!groovy,!livy,!hbase,!file,!flink,!ignite,!kylin,!lens' && \
