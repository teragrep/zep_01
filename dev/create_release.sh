...
git_clone
make_source_package
make_binary_release netinst "-Pweb-angular -Phadoop-2.6 -pl !hbase,!pig,!jdbc,!file,!ignite,!kylin,!lens,!elasticsearch,!bigquery,!livy,!groovy,!sap,!java,!geode,!neo4j,!sparql,!ksql -am"
